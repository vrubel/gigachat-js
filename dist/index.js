...
const interfaces_1 = require("./interfaces/index.js");
...
class GigaChat {
    ...
    async updateToken() {
        ...
        if (this._settings.credentials) {
            const credData = await (0, api_1.post_auth)(this._authClient, {
    ...
    async embeddingsBatch(payload) {
        return this._decorator(() => (0, api_1.post_batch)(this._client, {
            batch: payload,
            method: interfaces_1.BATCH_METHOD.embedder,
            accessToken: this.token,
        }));
    }
    async getModels() {
    ...
    async chatsBatch(payload) {
        ...
        return this._decorator(() => (0, api_1.post_batch)(this._client, {
            batch,
            method: interfaces_1.BATCH_METHOD.chatCompletions,
            accessToken: this.token,
        }));
    }
    async getBatch(fileId) {
        return this._decorator(() => (0, api_1.get_batch)(this._client, { fileId, accessToken: this.token }));
    }
    async getBatches() {
        return this._decorator(() => (0, api_1.get_batches)(this._client, { accessToken: this.token }));
    }
    async getBatchStatus(batchId) {
        return this._decorator(() => (0, api_1.get_batch_status)(this._client, {
            batchId,
            accessToken: this.token,
        }));
    }
